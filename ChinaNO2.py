# -*- coding: utf-8 -*-
"""
Created on Wed Jun 10 15:50:27 2020
...
popy_dir = 'C:/Users/baoxinbin123/OneDrive/桌面/TROPOMI卫星数据处理/popy/'
...
for year in range(start_year,end_year+1):
    for month in range(1,13):
        ...
        s5p = popy(instrum="TROPOMI",product="NO2",grid_size=0.02,\
                west=113,east=120,south=36,north=43,\
                start_year=year,start_month=month,start_day=1,\
                end_year=year,end_month=month,end_day=30,\
        ...
        m = Basemap(projection='cyl',llcrnrlat=36,urcrnrlat=43,\
            llcrnrlon=113,urcrnrlon=120,resolution='c')
        plt.rcParams["font.family"] = "Arial"
        
        
        # labels = [left,right,top,bottom]
        parallels = np.arange(37., 43., 1.)    # 这两行画纬度，范围为[-90,90]间隔为10
        m.drawparallels(parallels,labels=[True, False, False, False],fontsize=14)
        meridians = np.arange(114., 120., 1.)   # 这两行画经度，范围为[-180,180]间隔为10
